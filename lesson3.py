...
print(my_func(surname = 'Ivanov', name = 'Sergey', year = '1979', city = 'Moscow', email = 'ivanovS@mail.ru', telephone = '8-999-000-00-87'))
'''
...
#Задание 5. Программа запрашивает у пользователя строку чисел, разделенных пробелом. При нажатии Enter должна выводиться сумма чисел.
